...
@section('content')
    ...
    <add-modal title="Add New General Item" :inputs="{{json_encode($inputs)}}" url="/items"></add-modal>
    <edit-modal title="Edit General Item" :inputs="{{json_encode($inputs)}}" url="/items"></edit-modal>
@endsection
