...
@section('content_title', 'Kitchen Inventory Transfer Confirm')
@section('kitchen_inventory_confirm','active-link')
    ...
    <header class="header pl-2">
        <div class="d-flex justify-content-between">
            <nav style="margin-top: 8px">
                <a href="#" class="a-clear text-dark fm-roboto fs17">Kitchen Inventory Transfer Confirm</a>
            </nav>
        </div>
    </header>
    <div>
